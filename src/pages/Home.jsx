        ...
        <div className="grid gap-8 xl:grid-cols-[minmax(0,1.35fr)_minmax(320px,0.85fr)] xl:items-start">
          <div className="space-y-8">
            <div className="flex flex-wrap items-end justify-between gap-4">
              <div>
                <p className="theme-light-keep-dark text-4xl uppercase tracking-[0.25em] text-saffron">
                  {tr("Le Menu", "Menu")}
                </p>
              </div>
          ...
          <div className="space-y-5 xl:sticky xl:top-28">
            ...
            <article id="services" className="glass-panel p-5 sm:p-6">
              ...
              <div className="mt-5 grid gap-3">
                ...
                <div className="rounded-2xl border border-white/10 bg-black/20 p-4">
                  <p className="text-base font-bold text-white">{tr("Qualite constante", "Consistent quality")}</p>
                  <p className="mt-2 text-sm text-stone-300">
                    {tr(
